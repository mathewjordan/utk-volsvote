 ...
 */
class TCPDF_IMPORT extends \SearchWP\Dependencies\TCPDF
{
    /**
    ...
    public function importPDF($filename)
    {
        ...
        $cfg = array('die_for_errors' => \false, 'ignore_filter_decoding_errors' => \true, 'ignore_missing_filter_decoders' => \true);
        try {
            // parse PDF data
            $pdf = new \SearchWP\Dependencies\TCPDF_PARSER($rawdata, $cfg);
        } catch (\Exception $e) {
            die($e->getMessage());
        }
        // get the parsed data
 ...
 * @author Nicola Asuni - info@tecnick.com
 */
\class_alias('SearchWP\\Dependencies\\TCPDF_IMPORT', 'TCPDF_IMPORT', \false);
// END OF CLASS
//============================================================+
// END OF FILE
//============================================================+
