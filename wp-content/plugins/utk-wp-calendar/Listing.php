...
class Listing
{
    ...
    {
        /*
         * starts a session if not already set.
         */
    ...
    public static function utk_calendar_wrap($atts)
    {
        ...
        */
        ...
        $output .= '<a class="utk-calendar--header--url" href="' . Data::utk_calendar_more_url($department_id) . '" target="_blank">More Events</a>';
        $output .= '</div>';
    ...
    public static function utk_calendar_listing_instance($data, $figure)
    {
        ...
        $instance = '
        <li class="utk-calendar-event" id="utk-calendar-event-' . $data->id . '">
            <a href="' . $data->localist_url . '" target="_blank" title="' . $data->title . '">'
                . $figure_rendering .
                '<div class="utk-calendar-event--body">
                    ...
                    <div class="utk-calendar-event--time">
                        ...
                        <span class="utk-calendar-event--time--start">
                            '
                              . $date['start']['month_abbr'] . '. ' . $date['start']['day'] . ' @ '
